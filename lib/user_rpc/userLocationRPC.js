...
UserLocationRPCServiceFacet.prototype._flushuser = function(rpc) {
  ...
  return this._locationService.call('flushuser', user); // pass raw internal result back to user
};
...
UserLocationRPCServiceFacet.prototype._flushzone = function(rpc, zone) {
  ...
  return this._locationService.call('flushzone', user, zone); // pass raw internal result back to user
};
...
UserLocationRPCServiceFacet.prototype._locate = function(rpc, device, readings) {
  ...
  return this._locationService.call('locate', user, device, readings); // pass raw internal result back to user
};
...
UserLocationRPCServiceFacet.prototype._calibrationScore = function(rpc) {
  ...
  return this._locationService.call('calibrationScore', user); // pass raw internal result back to user
};
...
UserLocationRPCServiceFacet.prototype._score = function(rpc) {
  ...
  return this._locationService.call('score', user); // pass raw internal result back to user
};
...
UserLocationRPCServiceFacet.prototype._lastSeen = function(rpc, device) {
  ...
  return this._locationService.call('lastSeen', user, device); // pass raw internal result back to user
};
